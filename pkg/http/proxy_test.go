...
func TestHttpProxy_AddRequestHook(t *testing.T) {
	...
	hook1 := func(req vayload.HttpRequest, proxyReq *http.Request) error {
		proxyReq.Header.Set("X-Hook1", "value1")
		return nil
	}

	hook2 := func(req vayload.HttpRequest, proxyReq *http.Request) error {
...
func TestHttpProxy_AddResponseHook(t *testing.T) {
	...
	hook1 := func(req vayload.HttpRequest, proxyRes *http.Response) error {
		proxyRes.Header.Set("X-Response-Hook1", "value1")
		return nil
	}

	hook2 := func(req vayload.HttpRequest, proxyRes *http.Response) error {
...
// Mock vayload.HttpRequest for testing proxy
...
func (m *mockProxyRequest) Auth() *vayload.HttpAuth                                       { return nil }
...
// Mock vayload.HttpResponse for testing proxy
...
func (m *mockProxyResponse) Status(status int) vayload.HttpResponse {
	m.statusCode = status
	return m
}
func (m *mockProxyResponse) Redirect(path string, status int) error                  { return nil }
func (m *mockProxyResponse) SetBodyStreamWriter(writer vayload.StreamWriter) error   { return nil }
func (m *mockProxyResponse) Cookie(cookie *vayload.Cookie) vayload.HttpResponse      { return m }
func (m *mockProxyResponse) Cookies(cookies ...*vayload.Cookie) vayload.HttpResponse { return m }
...
func TestHttpProxy_Handle(t *testing.T) {
	...
	// Add request hook
	proxy.AddRequestHook(func(req vayload.HttpRequest, proxyReq *http.Request) error {
	...
	proxy.AddResponseHook(func(req vayload.HttpRequest, proxyRes *http.Response) error {
...
func TestHttpProxy_HandleWithBodyHook(t *testing.T) {
	...
	t.Run("With body modification hook", func(t *testing.T) {
		...
		// Body modifier hook
		bodyModifier := func(req vayload.HttpRequest, body *map[string]any) error {
			(*body)["modified"] = true
...
func TestProxyRequestHook_Type(t *testing.T) {
	var hook ProxyRequestHook = func(req vayload.HttpRequest, proxyReq *http.Request) error {
...
func TestProxyResponseHook_Type(t *testing.T) {
	var hook ProxyResponseHook = func(req vayload.HttpRequest, proxyRes *http.Response) error {
...
func TestBodyModifierHook_Type(t *testing.T) {
	var hook BodyModifierHook = func(req vayload.HttpRequest, body *map[string]any) error {
		(*body)["modified"] = true
		return nil
	}
