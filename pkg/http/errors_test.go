...
func (m *mockHttpRequest) Auth() *vayload.HttpAuth                                       { return nil }
...
func (m *mockHttpResponse) Status(status int) vayload.HttpResponse {
	m.statusCode = status
	return m
}
func (m *mockHttpResponse) Redirect(path string, status int) error                  { return nil }
func (m *mockHttpResponse) SetBodyStreamWriter(writer vayload.StreamWriter) error   { return nil }
func (m *mockHttpResponse) Cookie(cookie *vayload.Cookie) vayload.HttpResponse      { return m }
func (m *mockHttpResponse) Cookies(cookies ...*vayload.Cookie) vayload.HttpResponse { return m }
