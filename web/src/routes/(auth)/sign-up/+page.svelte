<script lang="ts">
    ...
    const handleSubmit = async (event: Event) => {
        ...
        await authStore.signUp(email, password, email.split("@")[0]);
        goto("/");
...
<div class="relative w-full max-w-sm md:max-w-4xl mx-auto">
        ...
        <Card.Root class="overflow-hidden p-0">
            <Card.Content class="grid p-0 md:grid-cols-2">
                ...
                <div class="bg-muted relative hidden md:block">
                    <img
                        src="https://images.pexels.com/photos/25626444/pexels-photo-25626444.jpeg"
                        alt=""
                        class="absolute inset-0 h-full w-full object-cover dark:brightness-[0.25] dark:grayscale"
                    />
                </div>
            </Card.Content>
        </Card.Root>
