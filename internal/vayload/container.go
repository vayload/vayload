...
type Container interface {
	...
	// SetInstance registers a new dependency in the container.
	SetInstance(name string, instance any) error
	...
	// Deferred registers a new deferred dependency in the container.
	Deferred(name string, target func(Container) (any, error), shared bool) error
	...
	GetInto(name string, target any) error
