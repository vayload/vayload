...
func (event *UserLoggedInEvent) EventKey() string {
...
func (event *UserCreatedEvent) EventKey() string {
...
func (event *UserUpdatedEvent) EventKey() string {
...
func (event *UserUpdateCodeEvent) EventKey() string {
...
func (event *OtpCodeGeneratedEvent) EventKey() string {
...
func (event *UserMagicLinkGeneratedEvent) EventKey() string {
...
func (event *UserPasswordRecoveryRequestedEvent) EventKey() string {
...
func (event *UserPasswordResetCompletedEvent) EventKey() string {
...
func (event *UserEmailChangeRequestedEvent) EventKey() string {
...
func (event *UserEmailChangeConfirmedEvent) EventKey() string {
