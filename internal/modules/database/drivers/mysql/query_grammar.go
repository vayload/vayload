...
type MySQLQueryGrammar struct{}

func NewQueryGrammar() *MySQLQueryGrammar {
	return &MySQLQueryGrammar{}
}

func (g *MySQLQueryGrammar) Compile(ast *query.Query) (string, []any) {
	switch ast.StmtType {
...
func (g *MySQLQueryGrammar) buildSelect(ast *query.Query) (string, []any) {
...
func (g *MySQLQueryGrammar) buildInsert(ast *query.Query) (string, []any) {
	var query strings.Builder
	args := make([]any, 0)
...
func (g *MySQLQueryGrammar) buildUpdate(ast *query.Query) (string, []any) {
	var query strings.Builder
	args := make([]any, 0)
...
func (g *MySQLQueryGrammar) buildUpsert(ast *query.Query) (string, []any) {
	var query strings.Builder
	args := make([]any, 0)
...
func (g *MySQLQueryGrammar) buildDelete(ast *query.Query) (string, []any) {
	var query strings.Builder
	args := make([]any, 0)
...
func (g *MySQLQueryGrammar) buildWhere(ast *query.Query) (string, []any) {
...
func (g *MySQLQueryGrammar) Placeholder(position int) string {
	return "?"
}

func (g *MySQLQueryGrammar) Wrap(value string) string {
	return ""
}

var _ grammar.QueryGrammar = (*MySQLQueryGrammar)(nil)
