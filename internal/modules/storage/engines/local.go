...
func (s *Store) Put(ctx context.Context, bucket string, key string, reader io.Reader) (PutResult, error) {
...
func (s *Store) Get(ctx context.Context, bucket string, key string) (io.ReadCloser, GetInfo, error) {
	path := objectPath(s.root, bucket, key)
...
func (s *Store) Stat(ctx context.Context, bucket string, key string) (ObjectInfo, error) {
